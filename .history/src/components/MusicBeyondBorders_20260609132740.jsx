...
const countries = [
  {
    name: "Sri Lanka",
    image: "/images/countries/srilanka.jpg",
    flagImage: "https://flagcdn.com/w160/lk.png",
    city: "Colombo",
    year: "2017",
    landmark: "Nelum Pokuna"
  },
  ...
  },
  {
    name: "Malaysia",
    image: "/images/countries/malaysia.jpg",
    flagImage: "https://flagcdn.com/w160/my.png",
    city: "Kuala Lumpur",
    year: "2023",
    landmark: "Petronas Towers"
  }
  ...
  return (
    <section className="mbb-section">
      ...
      >
        ...
        <div className="mbb-timeline-sidebar">
          <div className="mbb-timeline-line" />

          {countries.map(
            (country, index) => (
              <button
                key={index}
                className={`mbb-side-point ${
                  activeIndex === index
                    ? "active"
                    : ""
                }`}
              ...
              >
                ...
                <div className="mbb-side-info">
                  <span className="mbb-side-year">
                    {country.year}
                  </span>

                  <span className="mbb-side-country">
                    {country.name}
                  </span>
                </div>
              </button>
        ...
        <div className="mbb-banner-card">
          <div className="mbb-banner-content">
            <span className="mbb-banner-year">
              {activeCountry.year}
            </span>
            ...
            <p className="mbb-banner-city">
              📍 {activeCountry.city}
            </p>

            <p className="mbb-banner-landmark">
              {
                activeCountry.landmark
              }
            </p>

            <div className="mbb-banner-tour">
              International Tour
            </div>
          </div>
