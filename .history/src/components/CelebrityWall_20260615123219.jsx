    ...
    >
      ...
      <div className="cw-premium-card-info">
        <span className="cw-card-label">
          {index >= 8 ? "FEATURED ANCHOR" : "FEATURED ARTIST"}
        </span>
      ...
      <div className="cw-premium-card-hover">
        <span className="cw-premium-hover-text">
          Explore
        </span>

        <span className="cw-premium-hover-arrow">
          →
        </span>
      </div>
    </div>
        ...
        <div className="cw-anchor-message">
    <span className="cw-anchor-tag">HOSTING EXCELLENCE</span>

    <h3 className="cw-anchor-title">
      More Than Music,
      <br />
      <span>Moments That Connected Hearts</span>
    </h3>

    <p className="cw-anchor-desc">
      The magic of every celebration was elevated by talented anchors who
      brought warmth, elegance, humour, and energy to the stage. Their
      presence transformed performances into unforgettable experiences,
      creating a seamless connection between artists and audiences.
    </p>
