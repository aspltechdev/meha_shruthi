...
const CelebrityWall = () => {
  ...
  <div className="cw-anchor-message">
    ...
    <p className="cw-anchor-desc">
      Beyond music, our celebrated anchors brought elegance,
      energy, and charisma to the stage, creating unforgettable
      experiences and keeping audiences engaged throughout every event.
    </p>
