    ...
    <section className="mbb-section">
      <div className="mbb-container">
        ...
        <div className="mbb-banner">
          ...
          {/* CINEMATIC VIDEO */}
          <div className="mbb-banner-video">
            <video
              key={activeIndex}
              className="mbb-video"
              autoPlay
            ...
            >
              <source
                src={activeCountry.video}
                type="video/mp4"
              />
            </video>

            <div className="mbb-video-overlay-gradient"></div>

            <div className="mbb-luxury-lines">
              <span></span>
              <span></span>
              <span></span>
            </div>

            <div className="mbb-light-orb mbb-orb-1"></div>
            <div className="mbb-light-orb mbb-orb-2"></div>
          </div>
            ...
            <div className="mbb-content">
              ...
              <div className="mbb-closing">
                <div className="mbb-closing-content">
                  ...
                  <div className="mbb-closing-icon">
                    🌏
                  </div>
