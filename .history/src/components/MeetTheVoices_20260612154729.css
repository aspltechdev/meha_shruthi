      ...
      <div className="mtv-theep-stage">
        {singers.map((singer, idx) => (
          ...
          >
            ...
            {/* ══ RIGHT HALF — full-bleed video background ══ */}
            <div className="mtv-theep-right">
              <div
                className="mtv-theep-video-bg-wrap"
                style={{ '--tint': singer.tintColor, '--accent': singer.accentColor }}
              >
                {/* Video */}
                <video
                  ref={idx === 0 ? videoRefMeera : videoRefKaushik}
                  className="mtv-theep-bg-video"
                ...
                <div className="mtv-theep-tint-overlay" />

                {/* Left fade — blends into the dark content panel */}
                <div className="mtv-theep-fade-left" />

                {/* Top vignette */}
                <div className="mtv-theep-fade-top" />

                {/* Specialty badge — top right */}
                <div className="mtv-theep-vid-badge" style={{ borderColor: singer.accentColor, color: singer.accentColor }}>
                  {singer.specialty.split('•')[0].trim()}
                </div>

                {/* Bottom info bar */}
                <div className="mtv-theep-vid-info">
                  <div className="mtv-theep-live-badge">
                    <span className="mtv-theep-live-dot" />
                    LIVE
                  </div>
                  <div className="mtv-theep-vid-name-block">
                    <span className="mtv-theep-vid-label">Now Performing</span>
                    <span className="mtv-theep-vid-artist" style={{ color: singer.accentColor }}>
                      {singer.fullName}
                    </span>
                  </div>
                </div>
