...
const MeetTheVoices = () => {
  ...
  const singers = [
    ...
    {
      id: 2,
      uniqueId: 'priya-the-melodist',
      name: 'PRIYA SRIDHARAN',
      fullName: 'Priya Sridharan',
      title: 'The Melody Weaver',
      role: 'Playback Vocalist & Performer',
      specialty: 'Folk • Fusion • Devotional',
      description: 'Priya weaves folk melodies with modern rhythms, creating a tapestry of sound that bridges generations and cultures effortlessly.',
      quote: 'Every note I sing is an offering to the universe',
      videoUrl: meeraVideo,
      posterImage: m2,
      stats: [
        { value: '18+', label: 'Years' },
        { value: '600+', label: 'Shows' },
        { value: '30+', label: 'Awards' },
      ],
      achievements: ['Folk Icon', 'Playback Artist', 'Cultural Ambassador'],
      accentColor: '#b87333',
      tintColor: 'rgba(120, 30, 20, 0.45)',
    },
    {
      id: 3,
      uniqueId: 'arjun-the-maestro',
      name: 'ARJUN SRIDHARAN',
      fullName: 'Arjun Sridharan',
      title: 'The Rhythm Maestro',
      role: 'Multi-Instrumentalist & Vocalist',
      specialty: 'Fusion • Semi-Classical • Live',
      description: 'Arjun commands the stage with rare multi-instrumental mastery, seamlessly blending semi-classical depth with high-energy live performances.',
      quote: 'The stage is my temple and every audience my congregation',
      videoUrl: kaushikVideo,
      posterImage: m1,
      stats: [
        { value: '12+', label: 'Years' },
        { value: '400+', label: 'Concerts' },
        { value: '20+', label: 'Awards' },
      ],
      achievements: ['Rising Star', 'Fusion Pioneer', 'Live Excellence Award'],
      accentColor: '#e8c56d',
      tintColor: 'rgba(10, 60, 40, 0.45)',
    },
  ];
            ...
            <div className="mtv-portrait-panel">
              ...
              >
                <img
                  ...
                  alt={singer.fullName}
                  className={`mtv-portrait-media ${singer.id === 0 || singer.id === 2 ? 'mtv-meera-img' : ''}`}
                />
