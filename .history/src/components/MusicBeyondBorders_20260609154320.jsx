...
.mbb-country-list::-webkit-scrollbar {
  display: none;
}
...
.mbb-country-thumb-overlay span {
  color: #fff;
...
.mbb-country-thumb:hover img {
  transform: scale(1.08);
}

.mbb-country-thumb.active {
  transform: scale(1.05);

  box-shadow:
    0 18px 35px rgba(181, 139, 98, 0.35),
    0 0 0 3px rgba(255, 255, 255, 0.85);
}

.mbb-country-thumb.active img {
  transform: scale(1.08);
}
