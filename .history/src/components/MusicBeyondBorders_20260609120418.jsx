      ...
      <div className="mbb-container">
        ...
        <div className="mbb-hero">
          ...
          <div className="mbb-content">
            ...
            <span className="mbb-year-label">
              {active.year}
            </span>

            <div className="mbb-accent-line"></div>

            <h3 className="mbb-country-name">
              {active.name}
            </h3>
            ...
            <div className="mbb-stats">
              ...
              <div className="mbb-stat">
                <span className="mbb-stat-number">
                  8+
                </span>

                <span className="mbb-stat-label">
                  Countries
                </span>
              </div>
          ...
          {/* Right Image */}
          <div className="mbb-image-wrapper">

            <div className="mbb-image-card">
              ...
              <div className="mbb-image-overlay">

                <div className="mbb-overlay-content">

                  <span className="mbb-overlay-city">
                    {active.city}
                  </span>

                  <h4 className="mbb-overlay-country">
                    {active.name}
                  </h4>
        ...
        <div className="mbb-timeline">
          ...
          <div className="mbb-timeline-line"></div>
          ...
          {countries.map((country, index) => (
            ...
            >
              ...
              <span className="mbb-timeline-flag">
                {country.flag}
              </span>

              <span className="mbb-timeline-country">
                {country.name.length > 7
