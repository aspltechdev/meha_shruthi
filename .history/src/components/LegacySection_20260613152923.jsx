...
// import hero from '../assets/hero.mp4'; // keep import if used elsewhere
...
// Floating milestone cards shown around the hero image (year + title only)
const floatingCards = [
    ...
    <img src={yourImage} alt="artist" />
      ...
      <div className="legacy-pro-timeline-section">
        ...
        <div className="legacy-pro-timeline-header">
          ...
          <h2 className="legacy-pro-timeline-heading">Milestones of Excellence</h2>
        </div>

        {/* All 4 milestone cards — always visible */}
          ...
          {milestones.map((milestone, index) => (
            <div key={milestone.year} className="legacy-pro-milestone-card">
              ...
              <div className="legacy-pro-milestone-body">
                <div className="legacy-pro-milestone-year-tag">
                  {milestone.year}
                </div>
