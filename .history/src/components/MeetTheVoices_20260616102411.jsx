  ...
  useEffect(() => {
    ...
    const singers = [
      ...
      },
      {
        ...
        description: 'Captivates audiences with her soulful voice and magnetic stage presence, seamlessly blending classical roots with contemporary flair across live concert stages.',
