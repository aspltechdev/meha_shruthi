...
const MusicBeyondBorders = () => {
  return (
    <section className="mbb-section">
      <div className="mbb-page">

        {/* Sumário label */}
        <div className="mbb-sumario">
          <span className="mbb-badge-dot"></span>
          <span className="mbb-sumario-text">Sumário</span>
        </div>

        {/* Top description */}
        <div className="mbb-desc-top">
        ...
        <div className="mbb-canvas">

          {/* White text block — left, behind tiles */}
          <div className="mbb-tile t12 color-white">
            <div className="mbb-tile-body">
              <p className="mbb-desc-text">
                Os espetáculos trouxeram emoções únicas, conectando culturas e criando memórias inesquecíveis em cada palco.
              </p>
              <span className="mbb-tile-page" style={{ marginTop: '10px', display: 'block' }}>
                Tabela de Indicadores · página 15
              </span>
            </div>
          </div>

          {/* 1. Canada — large photo, bottom-left */}
          <div className="mbb-tile t1 color-pink">
            <div className="mbb-tile-img" style={{ backgroundImage: `url('/images/countries/canada.jpg')` }} />
            <div className="mbb-tile-overlay" />
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">1.</span>
              <span className="mbb-tile-name">Canada</span>
              <span className="mbb-tile-city">Toronto · 2019</span>
              <span className="mbb-tile-page">página 16</span>
            </div>
          </div>

          {/* 2. UK — medium solid purple */}
          <div className="mbb-tile t2 color-purple">
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">2.</span>
              <span className="mbb-tile-name">United Kingdom</span>
              <span className="mbb-tile-city">London · 2018</span>
              <span className="mbb-tile-page">página 24</span>
            </div>
          </div>

          {/* 3. Malaysia — tall solid dark */}
          <div className="mbb-tile t3 color-green-dark">
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">3.</span>
              <span className="mbb-tile-name">Malaysia</span>
              <span className="mbb-tile-city">Kuala Lumpur · 2023</span>
              <span className="mbb-tile-page">página 46</span>
            </div>
          </div>

          {/* 4. Australia — small solid */}
          <div className="mbb-tile t4 color-olive">
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">4.</span>
              <span className="mbb-tile-name">Australia</span>
            </div>
          </div>

          {/* Big landscape photo — center */}
          <div className="mbb-tile t5 color-photo">
            <div className="mbb-tile-img" style={{ backgroundImage: `url('/images/countries/singapore.jpg')` }} />
            <div className="mbb-tile-overlay" />
          </div>

          {/* 7. Sri Lanka — small orange accent */}
          <div className="mbb-tile t8 color-orange">
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">7.</span>
              <span className="mbb-tile-name">Sri Lanka</span>
            </div>
          </div>

          {/* 5. Singapore — medium magenta */}
          <div className="mbb-tile t6 color-magenta">
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">5.</span>
              <span className="mbb-tile-name">Singapore</span>
              <span className="mbb-tile-city">Marina Bay · 2019</span>
              <span className="mbb-tile-page">página 80</span>
            </div>
          </div>

          {/* Small yellow accent */}
          <div className="mbb-tile t10 color-yellow" />

          {/* World Tour tag */}
          <div className="mbb-tile t11 color-dark">
            <div className="mbb-tile-body mbb-center">
              <span className="mbb-gri">✈</span>
              <span className="mbb-gri-label">World Tour</span>
            </div>
          </div>

          {/* 6. Denmark — upper right violet */}
          <div className="mbb-tile t7 color-violet">
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">6.</span>
              <span className="mbb-tile-name">Denmark</span>
              <span className="mbb-tile-city">Copenhagen · 2022</span>
              <span className="mbb-tile-page">página 92</span>
            </div>
          </div>

          {/* 8. Switzerland — wide photo right */}
          <div className="mbb-tile t9 color-photo-blue">
            <div className="mbb-tile-img" style={{ backgroundImage: `url('/images/countries/switzerland.jpg')` }} />
            <div className="mbb-tile-overlay-blue" />
            <div className="mbb-tile-body">
              <span className="mbb-tile-num">8.</span>
              <span className="mbb-tile-name">Switzerland</span>
              <span className="mbb-tile-city">Zurich · 2021</span>
            </div>
          </div>

          {/* Decorative dots */}
          <div className="mbb-dot-deco d1" />
          <div className="mbb-dot-deco d2" />
          <div className="mbb-dot-deco d3" />
