...
const MusicBeyondBorders = () => {
  ...
  return (
    <section className="mbb-layout-section" ref={sectionRef}>
      ...
      {/* Loading indicator */}
      {!isVideoLoaded && (
        <div className="mbb-layout-loader">
          <div className="mbb-layout-loader-spinner"></div>
        </div>
      )}
      ...
      <div className="mbb-layout-container">
        ...
        <div className="mbb-layout-main">
          ...
          {/* RIGHT COLUMN: Header + Stats + Quote + Flags + CTA */}
          <div className="mbb-layout-side">
