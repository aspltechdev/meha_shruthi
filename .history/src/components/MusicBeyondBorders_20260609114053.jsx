...
const countries = [
  ...
  {
    name: "Denmark",
    image: "https://flagcdn.com/w1280/dk.png",
    city: "Copenhagen",
    year: "2022",
    flag: "🇩🇰",
  },
  {
    name: "Switzerland",
    image: "https://flagcdn.com/w1280/ch.png",
    city: "Zurich",
    year: "2021",
    flag: "🇨🇭",
  },
  {
    name: "Singapore",
    image: "https://flagcdn.com/w1280/sg.png",
    city: "Marina Bay",
    year: "2019",
    flag: "🇸🇬",
  },
  {
    name: "Malaysia",
    image: "https://flagcdn.com/w1280/my.png",
    city: "Kuala Lumpur",
    year: "2023",
    flag: "🇲🇾",
  },
  {
    name: "Sri Lanka",
    image: "https://flagcdn.com/w1280/lk.png",
    city: "Colombo",
    year: "2017",
    flag: "🇱🇰",
  },
...
const MusicBeyondBorders = () => {
  ...
  useEffect(() => {
    if (globeRef.current) {
      globeRef.current.style.transform = `rotate(${
        activeIndex * 45
      }deg)`;
    }
  }, [activeIndex]);
  ...
  return (
    <section className="mbb-section">
      ...
      <div className="mbb-globe-container">
        <div className="mbb-globe" ref={globeRef}>
          ...
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className="mbb-globe-parallel-line"
              style={{
                top: `${25 + i * 15}%`,
              }}
            />
          ...
          {countries.map((country, i) => (
            <div
              key={i}
              className={`mbb-globe-dot ${
                i === activeIndex ? "mbb-dot-active" : ""
              }`}
              style={{
                left: `${20 + i * 8}%`,
                top: `${20 + (i % 3) * 25}%`,
            ...
            >
              <span className="mbb-dot-tooltip">
      ...
      <div className="mbb-header">
        ...
        <h2 className="mbb-headline">
          <span className="mbb-headline-main">
            Music Beyond
          </span>

          <span className="mbb-headline-accent">
            Borders
          </span>
        </h2>
        ...
        <div className="mbb-header-metrics">
          <div className="mbb-metric">
            ...
            <span className="mbb-metric-unit">
              Countries
            </span>
          </div>

          <div className="mbb-metric-divider">
            •
          </div>
      ...
      <div
        className="mbb-showcase"
        onMouseEnter={() => setIsPaused(true)}
        onMouseLeave={() => setIsPaused(false)}
      >
        <div className="mbb-showcase-card">
          <img
            src={activeCountry.image}
            alt={activeCountry.name}
            className="mbb-showcase-image"
          />

          <div className="mbb-showcase-content">
            <div
              style={{
                fontSize: "4rem",
                marginBottom: "12px",
            ...
            <h3 className="mbb-showcase-country">
              {activeCountry.name}
            </h3>

            <p className="mbb-showcase-city">
              📍 {activeCountry.city}
            </p>

            <div className="mbb-showcase-year">
              {activeCountry.year}
            </div>
          </div>
        </div>
        ...
        <div className="mbb-horizontal-timeline">
          <div className="mbb-timeline-track">
            {countries.map((country, index) => (
              <button
                key={index}
                className={`mbb-timeline-item ${
                  activeIndex === index
                    ? "active"
                    : ""
                }`}
              ...
              >
                <span className="mbb-timeline-year">
                  {country.year}
                </span>

                <span className="mbb-timeline-dot" />
      ...
      <div className="mbb-statement">
        <div className="mbb-statement-bg-text">
          WORLD TOUR
        </div>
        ...
        <div className="mbb-statement-content">
          ...
          <h3 className="mbb-statement-quote">
            ...
            <span className="mbb-statement-highlight">
