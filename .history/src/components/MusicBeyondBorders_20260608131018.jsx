...
// export default MusicBeyondBorders;
import './MosaicTOC.css';

const MosaicTOC = () => {
  return (
    <section className="mtoc-section">
      <div className="mtoc-page">

        {/* Sumário label */}
        <div className="mtoc-sumario">
          <span className="mtoc-dot"></span>
          <span className="mtoc-sumario-text">Sumário</span>
        </div>

        {/* Top description */}
        <div className="mtoc-desc">
          <p>Principais países visitados e as histórias que ficaram gravadas em cada performance ao redor do mundo.</p>
        </div>

        {/* Scattered mosaic canvas */}
        <div className="mtoc-canvas">

          {/* T12: White text block — left, behind tiles */}
          <div className="mtoc-tile t12 color-white">
            <div className="mtoc-tile-body">
              <p className="mtoc-desc-text">
                Os espetáculos trouxeram emoções únicas, conectando culturas e criando memórias inesquecíveis em cada palco.
              </p>
              <span className="mtoc-tile-page" style={{ marginTop: '10px', display: 'block' }}>
                Tabela de Indicadores · página 15
              </span>
            </div>
          </div>

          {/* T1: Canada — large photo, bottom-left */}
          <div className="mtoc-tile t1 color-pink">
            <div className="mtoc-tile-img" style={{ backgroundImage: `url('/images/countries/canada.jpg')` }} />
            <div className="mtoc-tile-overlay" />
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">1.</span>
              <span className="mtoc-tile-name">Canada</span>
              <span className="mtoc-tile-city">Toronto</span>
              <span className="mtoc-tile-page">página 16</span>
            </div>
          </div>

          {/* T2: UK — medium solid purple */}
          <div className="mtoc-tile t2 color-purple">
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">2.</span>
              <span className="mtoc-tile-name">United Kingdom</span>
              <span className="mtoc-tile-city">London</span>
              <span className="mtoc-tile-page">página 24</span>
            </div>
          </div>

          {/* T3: Malaysia — tall dark green */}
          <div className="mtoc-tile t3 color-green-dark">
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">3.</span>
              <span className="mtoc-tile-name">Malaysia</span>
              <span className="mtoc-tile-city">Kuala Lumpur</span>
              <span className="mtoc-tile-page">página 46</span>
            </div>
          </div>

          {/* T4: Australia — small olive */}
          <div className="mtoc-tile t4 color-olive">
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">4.</span>
              <span className="mtoc-tile-name">Australia</span>
            </div>
          </div>

          {/* T8: Sri Lanka — small orange accent */}
          <div className="mtoc-tile t8 color-orange">
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">7.</span>
              <span className="mtoc-tile-name">Sri Lanka</span>
            </div>
          </div>

          {/* T5: Big landscape photo center */}
          <div className="mtoc-tile t5 color-photo">
            <div className="mtoc-tile-img" style={{ backgroundImage: `url('/images/countries/singapore.jpg')` }} />
            <div className="mtoc-tile-overlay" />
          </div>

          {/* T6: Singapore — medium magenta */}
          <div className="mtoc-tile t6 color-magenta">
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">5.</span>
              <span className="mtoc-tile-name">Singapore</span>
              <span className="mtoc-tile-city">Marina Bay</span>
              <span className="mtoc-tile-page">página 80</span>
            </div>
          </div>

          {/* T10: Small yellow accent */}
          <div className="mtoc-tile t10 color-yellow" />

          {/* T11: World Tour tag */}
          <div className="mtoc-tile t11 color-dark">
            <div className="mtoc-tile-body mtoc-center">
              <span className="mtoc-gri">✈</span>
              <span className="mtoc-gri-label">World Tour</span>
            </div>
          </div>

          {/* T7: Denmark — upper right violet */}
          <div className="mtoc-tile t7 color-violet">
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">6.</span>
              <span className="mtoc-tile-name">Denmark</span>
              <span className="mtoc-tile-city">Copenhagen</span>
              <span className="mtoc-tile-page">página 92</span>
            </div>
          </div>

          {/* T9: Switzerland — wide photo right */}
          <div className="mtoc-tile t9 color-photo-blue">
            <div className="mtoc-tile-img" style={{ backgroundImage: `url('/images/countries/switzerland.jpg')` }} />
            <div className="mtoc-tile-overlay-blue" />
            <div className="mtoc-tile-body">
              <span className="mtoc-tile-num">8.</span>
              <span className="mtoc-tile-name">Switzerland</span>
              <span className="mtoc-tile-city">Zurich</span>
            </div>
          </div>

          {/* Decorative dots */}
          <div className="mtoc-dot-deco d1" />
          <div className="mtoc-dot-deco d2" />
          <div className="mtoc-dot-deco d3" />
