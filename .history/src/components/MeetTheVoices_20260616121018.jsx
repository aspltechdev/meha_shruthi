...
import vanathi from "../assets/vanathi.png";
import vanathiVideo from "../assets/vanathi.mp4";
...
const MeetTheVoices = () => {
  ...
  const singers = [
    ...
    },
    {
      ...
      title: 'The Soulful Voice',
      role: 'Vocalist & Live Performer',
      specialty: 'Carnatic • Melody • Live Performance',
      description: 'Brings depth and soul to every performance, blending classical roots with contemporary stagecraft.',
      quote: 'Every note I sing carries a piece of tradition into today',
      videoUrl: vanathiVideo,
      posterImage: vanathi,
      stats: [
      ...
      achievements: ['Classical Roots', 'Live Performer', 'Vocalist'],
      accentColor: '#d4a843',
      tintColor: 'rgba(255, 255, 255, 0.08)',
    },
  ];
