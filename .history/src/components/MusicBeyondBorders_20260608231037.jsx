...
const MusicBeyondBorders = () => {
  ...
  return (
    <section className="mbb-section">
      ...
      <div className="mbb-blob mbb-blob-a"></div>
      <div className="mbb-blob mbb-blob-b"></div>
      <div className="mbb-blob mbb-blob-c"></div>

      <div className="mbb-page">

        <div className="mbb-sumario">
          <span className="mbb-badge-dot"></span>
          <span className="mbb-sumario-text">
            Sumário
          </span>
        </div>
        ...
        <div className="mbb-desc-top">
          <p>
            Principais países visitados e as histórias
            que ficaram gravadas em cada performance
            ao redor do mundo.
          </p>
        </div>
                <div className="mbb-canvas">

          <div className="mbb-track"></div>

          {countries.map((country, index) => (
            <button
              key={country.id}
              className={`mbb-flag-node flag-${index + 1}
              ${
            ...
            >
              <span className="mbb-flag">
                {country.flag}
              </span>

              <span className="mbb-node-year">
                {country.year}
              </span>
            </button>
          ))}
                    <div className="mbb-detail-card">

            <div
              className="mbb-detail-image"
              style={{
                backgroundImage: `url(${activeCountry.image})`,
              }}
            />

            <div className="mbb-detail-content">

              <div className="mbb-detail-header">

                <span className="mbb-detail-flag">
                  {activeCountry.flag}
                </span>
              ...
              <div className="mbb-pill-row">

                <span className="mbb-pill">
                  {activeCountry.year}
                </span>

                <span className="mbb-pill">
                  {activeCountry.students}
                </span>
