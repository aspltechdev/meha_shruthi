...
<div className="cw-anchor-message">
  ...
  <h3 className="cw-anchor-title">
    Voices That <span>Connected</span> Every Moment
  </h3>

  <p className="cw-anchor-desc">
    Beyond music, the celebrations were elevated by charismatic anchors who
    brought warmth, energy, and elegance to the stage, creating unforgettable
    experiences for audiences across every event.
  </p>
