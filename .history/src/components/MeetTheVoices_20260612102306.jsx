...
const MeetTheVoices = () => {
  ...
  const singers = [
    {
      ...
      accentColor: "#c9a03d",
      bgGradient:
        "linear-gradient(135deg, #fff8f0, #fdf4e3)",
    },
    {
      id: 1,
      uniqueId: "kaushik-the-performer",
      ...
      accentColor: "#d4a843",
      bgGradient:
        "linear-gradient(135deg, #fff5e8, #fdf0e0)",
    },
  ];
  ...
  return (
    <section
  className="mtv-cinematic-wrapper"
  ref={sectionRef}
>
  {/* Spotlight */}
  <div
    ...
    style={{
      background: `radial-gradient(
        ...
        ${currentSinger.accentColor}15 0%,
        transparent 60%
      )`,
    }}
  />
  ...
  <div className="mtv-scroll-progress">
    <div
      ...
      style={{
        ...
        background: currentSinger.accentColor,
      }}
    />
    ...
    <div className="mtv-progress-dots">
      {singers.map((_, i) => (
        <div
          key={i}
          className={`mtv-progress-dot ${
            activeIndex === i ? "active" : ""
          }`}
          style={{
            background:
              activeIndex === i
                ? currentSinger.accentColor
                : "#d4c4a8",
          }}
        />
      ))}
  ...
  <div className="mtv-cinematic-container">
    {singers.map((singer, idx) => (
      ...
      >
        {/* LEFT */}
        <div
          className="mtv-slide-left"
          style={{
            background: singer.bgGradient,
          }}
        >
          <div className="mtv-video-background">
            ...
            <div className="mtv-video-overlay-bg" />
          </div>
          ...
          <div className="mtv-visual-atmosphere">
            ...
            <div className="mtv-cinematic-frame">
              ...
              <div className="mtv-image-container">
                ...
                <div className="mtv-image-overlay" />
              </div>
              ...
              <div className="mtv-sound-waves">
                ...
                <div
                  className="mtv-wave-ring delay-1"
                  style={{
                    borderColor:
                      singer.accentColor,
                  }}
                ...
                <div
                  className="mtv-wave-ring delay-2"
                  style={{
                    borderColor:
                      singer.accentColor,
                  }}
                />
                  ...
                  {/* MTV - Stats */}
                  <div className="mtv-stats-grid">
                    <div className="mtv-stat-card">
                      <div
                        className="mtv-stat-value"
                        style={{ color: singer.accent }}
                      >
                        {singer.stats.performances}
                      </div>
                  ...
                  {/* MTV - Achievements */}
                  <div className="mtv-achievements">
                    {singer.achievements.map((achievement, idx) => (
                      <div
                        key={idx}
                        className="mtv-achievement-tag"
                        style={{
                          borderColor: singer.accent,
                          color: singer.accent,
                        }}
                      >
                        <span
                  ...
                  {singer.ctaText && (
                    <button
                      ...
                      onClick={() => {
                        if (singer.ctaLink) {
                          window.open(singer.ctaLink, "_blank");
                        }
                      }}
                    >
                      <span>{singer.ctaText}</span>
