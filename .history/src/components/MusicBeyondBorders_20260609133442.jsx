  ...
  return (
    <section className="mbb-section">
      ...
      >
        ...
        <div className="mbb-banner">
          ...
          <div className="mbb-banner-content">
            ...
            <span className="mbb-country-year">
              {activeCountry.year}
            </span>

            <h3 className="mbb-country-title">
              {activeCountry.name}
            </h3>

            <p className="mbb-country-city">
              📍 {activeCountry.city}
            </p>

            <p className="mbb-country-landmark">
              {activeCountry.landmark}
            </p>

            <div className="mbb-tour-badge">
              INTERNATIONAL TOUR
            </div>
      ...
      <div className="mbb-footer">
        ...
        <div className="mbb-footer-line" />

        <p>
          Celebrating music across
