...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    if (video1 && video2 && video3) {
      ...
      const playVideo1 = () => {
        ...
        timeout = setTimeout(playVideo2, 10000);
      };
      ...
      const playVideo2 = () => {
        ...
        timeout = setTimeout(playVideo3, 10000);
      };
      ...
      const playVideo3 = () => {
        ...
        timeout = setTimeout(playVideo1, 10000);
      };
  ...
  return (
    ...
    >
      ...
      <div className="hero-pro__container">import React, { useEffect, useRef, useState } from 'react';
import './Hero.css';
import hero from "../../assets/hero.png";
import herovideo from '../../assets/videoone.mp4';
import herovideotwo from '../../assets/videothree.mp4';
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hero-pro__container"></div>
              {/* LEFT SIDE - CONTENT */}
        <div
