...
import herovideotwo from '../../assets/herooo.mp4';
import herovideothree from '../../assets/heroooo.mp4';
...
const playVideo1 = () => {
  ...
  timeout = setTimeout(playVideo2, 10000); // Video 1 → 10 sec
};
...
const playVideo2 = () => {
  ...
  return (
    <section
      className={`hero-pro ${isLoaded ? 'hero-pro--loaded' : ''}`}
      ref={heroRef}
    >
      {/* VIDEO BACKGROUND */}
