...
const MeetTheVoices = () => {
  ...
  title: 'The Sonic Storyteller',
  role: 'Playback Vocalist & Media Celebrity',
  specialty: 'Classical • Fusion • Contemporary',
  description: 'Nandini Sagar captivates audiences with her soulful voice and magnetic stage presence, seamlessly blending classical roots with contemporary flair across live concert stages.',
