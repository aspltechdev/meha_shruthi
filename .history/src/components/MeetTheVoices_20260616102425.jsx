  ...
  useEffect(() => {
    ...
    const singers = [
      ...
      },
      {
        ...
        description: 'commands the stage with her powerful voice and electrifying presence, delivering unforgettable live performances that leave audiences wanting more.',
