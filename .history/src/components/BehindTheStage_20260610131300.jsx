...
import canadaImg from '../assets/borderone.jpg'; import ukImg from '../assets/bordertwo.jpg'; import australiaImg from '../assets/borderthree.jpg'; import denmarkImg from '../assets/borderfour.jpg'; import switzerlandImg from '../assets/borderfive.jpg'; import singaporeImg from '../assets/bordersix.jpg'; import malaysiaImg from '../assets/borderseven.jpg'; import srilankaImg from '../assets/bordereight.jpg'; const countries = [ { name: "Canada", flag: "🇨🇦", city: "Toronto", year: "2019", venue: "Roy Thomson Hall", image: canadaImg, }, { name: "United Kingdom", flag: "🇬🇧", city: "London", year: "2018", venue: "Royal Albert Hall", image: ukImg, }, { name: "Australia", flag: "🇦🇺", city: "Sydney", year: "2020", venue: "Sydney Opera House", image: australiaImg, }, { name: "Denmark", flag: "🇩🇰", city: "Copenhagen", year: "2022", venue: "Koncerthuset", image: denmarkImg, }, { name: "Switzerland", flag: "🇨🇭", city: "Zurich", year: "2021", venue: "Tonhalle", image: switzerlandImg, }, { name: "Singapore", flag: "🇸🇬", city: "Marina Bay", year: "2019", venue: "Esplanade", image: singaporeImg, }, { name: "Malaysia", flag: "🇲🇾", city: "Kuala Lumpur", year: "2023", venue: "PETRONAS Theatre", image: malaysiaImg, }, { name: "Sri Lanka", flag: "🇱🇰", city: "Colombo", year: "2017", venue: "Nelum Pokuna", image: srilankaImg, }, ];
const BehindTheStage = () => {
  ...
  return (
    <section className="bts-premium-section" ref={sectionRef}>
      ...
      <div 
        ...
        style={{
          background: `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(201, 160, 61, 0.08) 0%, transparent 60%)`
        }}
      />
      ...
      <div className="bts-premium-header">
        <div className="bts-premium-badge">
          ...
          <span className="bts-badge-text">BEHIND THE STAGE</span>
          <span className="bts-badge-dot"></span>
        </div>

        <h2 className="bts-premium-title">
          <span className="bts-title-light">Before The</span>
          <span className="bts-title-gradient">Spotlight</span>
        </h2>

        <div className="bts-premium-subtitle">
          <span className="bts-subtitle-line"></span>
          <p>Every great performance begins in the shadows</p>
          <span className="bts-subtitle-line"></span>
        </div>
      </div>
      ...
      <div className="bts-premium-layout">
        ...
        >
          <div className="bts-feature-media">
            <div className="bts-feature-image-wrapper">
              <img
                src={moments[0].image}
                alt={moments[0].title}
                className="bts-feature-image"
              />
              <div className="bts-feature-overlay" style={{ background: moments[0].gradient }}></div>
            </div>

            {/* Live Recording Badge */}
            <div className="bts-live-badge">
              <span className="bts-live-dot"></span>
              <span className="bts-live-text">LIVE RECORDING</span>
            </div>
          ...
          <div className="bts-feature-content">
            ...
            <p className="bts-feature-subtitle">{moments[0].subtitle}</p>
            <div className="bts-feature-line"></div>
            <p className="bts-feature-description">{moments[0].description}</p>
          </div>
        ...
        <div className="bts-side-grid">
          {moments.slice(1).map((moment, index) => (
            <div
              key={index}
              className={`bts-side-premium ${activeIndex === index + 1 ? 'active' : ''}`}
              onMouseEnter={() => setActiveIndex(index + 1)}
              onMouseLeave={() => setActiveIndex(null)}
            >
              <div className="bts-side-media">
                <div className="bts-side-image-wrapper">
                  <img
                    src={moment.image}
                    alt={moment.title}
                    className="bts-side-image"
                  />
                  <div className="bts-side-overlay" style={{ background: moment.gradient }}></div>
                </div>
              ...
              <div className="bts-side-content">
                <div className="bts-side-icon">{moment.icon}</div>
                <div className="bts-side-info">
                  <h4 className="bts-side-title">{moment.title}</h4>
                  <p className="bts-side-subtitle">{moment.subtitle}</p>
                </div>
                <div className="bts-side-arrow">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path d="M5 12h14M12 5l7 7-7 7" strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                </div>
              </div>
      ...
      <div className="bts-film-gallery">
        ...
        <div className="bts-film-strip">
          <div className="bts-strip-track">
            {[...moments, ...moments].map((moment, i) => (
              <div key={i} className="bts-strip-frame">
                <img src={moment.image} alt="" className="bts-strip-image" />
                <div className="bts-strip-overlay"></div>
                <div className="bts-strip-number">{(i % moments.length) + 1}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bts-premium-quote">
        <div className="bts-quote-decoration">
          ...
          <span className="bts-quote-diamond">◈</span>
          <span className="bts-quote-line"></span>
        </div>
        
        <div className="bts-quote-content">
          <span className="bts-quote-mark">"</span>
          <p className="bts-quote-text">
            The magic you see on stage is <strong>crafted in the shadows</strong>
          </p>
          <span className="bts-quote-mark">"</span>
        </div>
        ...
        <div className="bts-quote-author">
          ...
          <span>Behind Every Performance</span>
          <span className="bts-author-line"></span>
        </div>
      </div>
