          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                height: '1px',
                width: '50px',
                background: 'linear-gradient(to right, transparent, #c9a03d)'
              }}></div>
              <span style={{
                fontSize: '10px',
                letterSpacing: '3px',
                ...
                fontWeight: '500',
                fontFamily: 'inherit'
              }}>Proudly Presented By</span>
              <div style={{
                height: '1px',
                width: '50px',
                background: 'linear-gradient(to left, transparent, #c9a03d)'
              }}></div>
            </div>
            <p style={{
              margin: 0,
              ...
              fontWeight: '600',
              letterSpacing: '1.5px',
              background: 'linear-gradient(135deg, #daa520, #c9a03d, #f5d06e, #b8860b)',
